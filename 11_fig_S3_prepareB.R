...
decouple <- readRDS("./export/objects/fig_S3B_decoupler.rds")
tcr <- readRDS("./export/objects/fig_S3B_tcr.rds")
deconvEPIC <- readRDS("./export/objects/fig_S3B_epic.rds")
deconvQuanTIseq <- readRDS("./export/objects/fig_S3B_quantiseq.rds")
...
SummarizedExperiment::colData(cluster1)[[cl1]] <- as.character(
  SummarizedExperiment::colData(cluster1)[[cl1]]
)
SummarizedExperiment::colData(cluster2)[[cl2]] <- as.character(
  SummarizedExperiment::colData(cluster2)[[cl2]]
)
SummarizedExperiment::colData(cluster3)[[cl3]] <- as.character(
  SummarizedExperiment::colData(cluster3)[[cl3]]
)
SummarizedExperiment::colData(clusterX)[[clX]] <- as.character(
  SummarizedExperiment::colData(clusterX)[[clX]]
)
...
saveRDS(plots_3b, file = "./export/objects/fig_S3B_panels.rds")

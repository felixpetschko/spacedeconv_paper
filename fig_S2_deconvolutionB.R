...
saveRDS(deconv, file = "./export/objects/fig_S2_decoupler.rds")
...
saveRDS(speTCR, file = "./export/objects/fig_S2_tcr.rds")
...
saveRDS(deconvEPIC, file = "./export/objects/fig_S2_epic.rds")
saveRDS(deconvQuanTIseq, file = "./export/objects/fig_S2_quantiseq.rds")
